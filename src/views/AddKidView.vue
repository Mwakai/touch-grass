      ...
      <section class="rounded-3xl bg-white p-8 shadow-lg shadow-slate-200">
        ...
        <form class="mt-8 space-y-6" @submit.prevent="handleSubmit">
          ...
          <div class="pt-4">
            <button
              type="submit"
              class="w-full rounded-2xl bg-emerald-500 py-3 text-lg font-semibold text-white shadow-lg shadow-emerald-500/30 transition hover:bg-emerald-600"
            >
              Add Kid
            </button>
            <button
